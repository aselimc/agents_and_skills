...
As for the summary itself, remember that you're processing this paper within the context of this repository, so most often we we will be interested in how to apply the paper and its lessons to this project. Therefore, you should feel free to "remind yourself" of the related this repositories code by reading the relevant parts, and then explicitly make the connection of how this paper might relate to this project or what are things we might be inspired about or try.